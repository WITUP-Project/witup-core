...
public class Resolver {
     ...
     */
    private static Set<String> findVariables(SymExpr expr) {
        Set<String> vars = new HashSet<>();
        collectVariables(expr, vars);
        return vars;
    }

    private static void collectVariables(SymExpr expr, Set<String> vars) {
     ...
     */
    private static String getVariableName(Value value) {
     ...
     */
    private static BinOp jimpleOpToBinOp(AbstractConditionExpr expr) {
     ...
     */
    private static BinOp jimpleBinopToBinOp(AbstractBinopExpr expr) {
     ...
     */
    private static SymExpr resolveVariables(SymExpr current, Set<String> varsToResolve,
                                            WITUpNode currentNode, WITUpGraph graph,
                                            Set<WITUpNode> visited) {
     ...
     */
    private static SymExpr valueToSymExpr(Value value) {
        // eg $stack1
        if (value instanceof Local) {
     ...
     */
    private static List<DataDependencyEdge> getIncomingDDGEdges(WITUpNode node, WITUpGraph graph) {
