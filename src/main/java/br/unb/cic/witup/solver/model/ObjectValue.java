...
public final class ObjectValue implements ModelValue {
  ...
  /**
   * Example: (declare-fun field_value (java.lang.Object) Int) is a declaration. Object field
   * mappings are function declarations In the case of Array.getObjectFromArray, the mapping becomes
   * java.lang.Object (all custom objects e.g MyObject become Object) and since we are comparing
   * with an int, the function range is Int.
   *
  ...
  public ModelValue getField(final String fieldName) {
    // Find the field_<name> function in the modelValueMap and apply it to this object
