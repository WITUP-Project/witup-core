...
public class IntTest {
  ...
  public void addOverflow() {
    ...
    int a = solution.getInt("a").value();
    int b = solution.getInt("b").value();
  ...
  public void greaterThanConstantRhs() {
    ...
    SolverResult solution = results.getFirst();
    assertTrue(solution.isSat());
    assertTrue(solution.getInt("a").value() < 0, "a < 0");
  }
  ...
  public void lesserThanConstantLhs() {
    ...
    SolverResult solution = results.getFirst();
    assertTrue(solution.isSat());
    assertTrue(solution.getInt("a").value() < 0, "Expected a < 0");
  }
  ...
  public void equalsConstantRhs() {
    ...
    SolverResult solution = results.getFirst();
    assertTrue(solution.isSat());
    assertEquals(0, solution.getInt("a").getValue(), "Expected a == 0");
  }
  ...
  public void lessThanConstantRhsViaBoolean() {
    ...
    assertTrue(sol1.getInt("a").getValue() < 0, "Expected a < 0");
  }
  ...
  public void lessThanConstantRhsViaNegatedBoolean() {
    ...
    assertTrue(sol0.getInt("a").getValue() >= 0, "Expected a >= 0");
